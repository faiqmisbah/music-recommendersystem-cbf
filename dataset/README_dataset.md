...
* **Description:** Contains audio features and metadata for 232,725 Spotify songs.
...
* **Description:** Contains song lyrics across multiple genres (379,931 lyrics).
...
* **Description:** Contains user listening history and profiles (23,822,550 records).
...
|---------|----------------|-----------|
| SpotifyFeatures.csv | 232,725 | 32 MB |
| lyrics-data.csv | 379,931 | 415 MB |
| user_top_tracks.csv | 23,822,550 | 1.57 GB |
